...
public:
    ...
    /**
     * Checks whether the partner of the player of which the index/turn is given has no cards left.
     *
     ...
     * @return true if the partner of the player of which the index/turn is given has
     *         no cards left, or false otherwise.
     */
    bool partnerHasNoCardsLeft(int playerTurn);

    /**
     * Checks whether the last three players have passed or have no cards left.
     *
     * @param playerTurn the turn of the game, which indicates which player is the next to play,
     *                   and is an integer with values 0, 1, 2 or 3
     ...
     *         no cards left, or false otherwise.
     */
    bool lastThreePlayersPassedOrHaveNoCardsLeft(int playerTurn);
